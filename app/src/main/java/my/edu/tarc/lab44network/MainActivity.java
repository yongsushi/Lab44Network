...
public class MainActivity extends AppCompatActivity {
    ...
    List<Course> caList; //store data
    private ProgressDialog pDialog; //block ui during loading
    //TODO: Please update the URL to point to your own server
    private static String GET_URL = "https://jomevent.000webhostapp.com/select_course.php";
    ...
    private void downloadCourse(Context context, String url) {
        ...
        JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) { //response declared in php file
                        try {
                            caList.clear();
